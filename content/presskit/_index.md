...
layout: simple
id: ""
title: DUNGEONERY PRESSKIT
---
<img src= "capsule.png">
<div>
  <h2 id="description">DESCRIPTION</h2>
  <p>Dungeonery is a roguelike autobattler where you lead a handpicked team of heroes through a dangerous dungeon, discover powerful items and relics, create devastating synergies, and outsmart your enemies with strategy and tactical choices. </p>
...
{{< /button >}}
  ...
  <h2 id="history">KEY FEATURES</h2>
  <strong>Assemble your team</strong>
...
* Your heroes have minds of their own, so the moment the fight starts, they will do whatever they think is best. Free will, huh? But don’t be fooled: the real decisions happen before the battle even begins. Composition and positioning of your team is what truly defines the outcome
* Deploy your team freely across the battlefield, but remember that the enemies will be attacking from all sides as well! Consider your options, adapt your strategy or face the consequences - if your whole team gets wiped out, the run is over!
* Remember to hydrate - efficient use of your potion slots can turn your luck around. Pick from diverse flavours such as emergency healing, immediately setting the enemies on fire or even summoning some helpful slimes!

<strong>Explore the dungeon</strong>
...
<img src="https://imgur.com/QI5fInZ.png" class="grid-w50 md:grid-w33 xl:grid-w25" />
<img src="https://imgur.com/WbbQz2O.png" class="grid-w50 md:grid-w33 xl:grid-w25" />
<img src="https://imgur.com/zvAWunE.png" class="grid-w50 md:grid-w33 xl:grid-w25" />
<img src="https://imgur.com/mMC0Jem.png" class="grid-w50 md:grid-w33 xl:grid-w25" />
<img src="https://imgur.com/ZKy0zFs.png" class="grid-w50 md:grid-w33 xl:grid-w25" />
<img src="https://imgur.com/mot5ugk.png" class="grid-w50 md:grid-w33 xl:grid-w25" />
<img src="https://imgur.com/s1E8mbP.png" class="grid-w50 md:grid-w33 xl:grid-w25" />
<img src="https://imgur.com/PTgz19U.png" class="grid-w50 md:grid-w33 xl:grid-w25" />
<img src="https://imgur.com/hAj5CIZ.png" class="grid-w50 md:grid-w33 xl:grid-w25" />
<img src="https://imgur.com/4vQdYPR.png" class="grid-w50 md:grid-w33 xl:grid-w25" />
<img src="https://imgur.com/gVjHwlw.png" class="grid-w50 md:grid-w33 xl:grid-w25" />
<img src="https://imgur.com/bQ4BHcK.png" class="grid-w50 md:grid-w33 xl:grid-w25" />
<img src="https://imgur.com/wdkFVKm.png" class="grid-w50 md:grid-w33 xl:grid-w25" />
<img src="https://imgur.com/nokzy8Y.png" class="grid-w50 md:grid-w33 xl:grid-w25" />
